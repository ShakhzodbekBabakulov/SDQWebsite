...
- 13 unit checks cover the approved timeline, exact four-second loops, wheel normalization, the 1.10x-1.20x speed band, gesture locking, reversal, boundaries, wrapping, reduced motion, keyboard input, and forward/reverse frame mapping.
